{{--
|--------------------------------------------------------------------------
| Pagina per la gestione delle idoneità
|--------------------------------------------------------------------------
--}}

@extends('layouts.app')

@section('title', 'Idoneità')
...
<div class="container-fluid py-4">
    ...
    <div class="text-center mb-4">
        <h1 class="page-title">Idoneità</h1>
    </div>
    ...
    <div id="filtersContainer" class="filter-section {{ $hasActiveFilters ? 'visible' : '' }}">
        @include('components.filters.filter-idoneita')
    </div>

    <div class="row mt-3">
        <div class="col">
            @include('components.tables.table-idoneita')
