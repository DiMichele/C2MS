    ...
    <table class="table table-sm table-bordered table-hover mb-0">
        <thead style="position: sticky; top: 0; z-index: 10;">
            <tr style="background-color: #0a2342; color: white;">
                ...
                <th style="min-width: 180px;">Tiri di Approntamento</th>
                <th style="min-width: 200px;">Mantenimento Arma Lunga</th>
                <th style="min-width: 200px;">Mantenimento Arma Corta</th>
            </tr>
        </thead>
        <tbody>
