...
@section('title', 'Nuovo Codice CPT')
...
<div class="text-center mb-4">
    <h1 class="page-title">NUOVO CODICE CPT</h1>
</div>
                ...
                <form action="{{ route('codici-cpt.store') }}" method="POST" id="formCodice">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="macro_attivita" class="form-select form-select-lg" required>
                            ...
                            @foreach($tutteCategorie as $cat)
                                <option value="{{ $cat }}" {{ old('macro_attivita') == $cat ? 'selected' : '' }}>
                                    {{ $cat }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="color-presets">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <button type="button" class="btn-color-preset" data-color="#00b050" title="Verde - Disponibile/Servizio">
                                    <span style="background: #00b050;"></span>
                                </button>
                                <button type="button" class="btn-color-preset" data-color="#ffff00" title="Giallo - Assente">
                                    <span style="background: #ffff00;"></span>
                                </button>
                                <button type="button" class="btn-color-preset" data-color="#ff0000" title="Rosso - Non Impiegabile">
                                    <span style="background: #ff0000;"></span>
                                </button>
                                <button type="button" class="btn-color-preset" data-color="#ffc000" title="Arancione - Approntamenti">
                                    <span style="background: #ffc000;"></span>
                                </button>
                                <button type="button" class="btn-color-preset" data-color="#0070c0" title="Blu - Servizi Speciali">
                                    <span style="background: #0070c0;"></span>
                                </button>
                                <button type="button" class="btn-color-preset" data-color="#000000" title="Nero - Comando">
                                    <span style="background: #000000;"></span>
                                </button>
                                <button type="button" class="btn-color-preset" data-color="#92d050" title="Verde Chiaro">
                                    <span style="background: #92d050;"></span>
                                </button>
                                <button type="button" class="btn-color-preset" data-color="#6c757d" title="Grigio - Default">
                    ...
                    <div class="d-flex gap-2 justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success px-4">
                            <i class="fas fa-save me-1"></i> Salva Codice
                        </button>
                    </div>
                </form>
            </div>
